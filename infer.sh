...
# # 对 SNIPS 数据集进行推理
# python infer.py -ifb 32 -md "../dataroot/models/Mistral/Mistral-7B-Instruct-v0.1" -pp "./save/model/snips/Mistral-7B-Instruct-v0.1_default" --data_file "./data/MixSNIPS_clean/test.json"
...
# python infer.py -ifb 32 -md "../dataroot/models/NousResearch/Llama-2-7b-chat-hf" -pp "./save/model/snips/Llama-2-7b-chat-hf_default" --data_file "./data/MixSNIPS_clean/test.json"
...
# python infer.py -ifb 32 -md "../dataroot/models/lmsys/vicuna-7b-v1.5" -pp "./save/model/snips/vicuna-7b-v1.5_default" --data_file "./data/MixSNIPS_clean/test.json"

python infer.py -ifb 6 -md "../dataroot/models/Mistral/Mistral-7B-Instruct-v0.1" -pp "./save/model/atis/Mistral-7B-Instruct-v0.1_sub"